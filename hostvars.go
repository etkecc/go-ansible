...
func (hv HostVars) Email() string {
	keys := []string{"etke_service_monitoring_email", "matrix_monitoring_email", "devture_traefik_config_certificatesResolvers_acme_email", "matrix_ssl_lets_encrypt_support_email"}
